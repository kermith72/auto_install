...
apt-get install -y librrd-dev libqt4-dev libqt4-sql-mysql libgnutls28-dev liblua5.2-dev lsb-release
...
DEBIAN_FRONTEND=noninteractive apt-get install -y --force-yes php7.1-sqlite3 \
	php-pear sudo tofrodos bsd-mailx lsb-release mariadb-server rrdtool \
	librrds-perl libconfig-inifiles-perl libcrypt-des-perl php-db php-date \
